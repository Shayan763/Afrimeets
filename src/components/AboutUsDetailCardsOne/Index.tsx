    ...
    return (
        <Container className='mt-20'>
            <div className='flex flex-col md:flex-row items-center justify-center w-full'>
                <div className='slide-in-from-left flex justify-center lg:justify-start md:w-1/2'>
                    <BaseImage
                ...
                <div className='flex flex-col items-center md:items-start md:w-1/2 w-3/4 space-y-4'>
                    <div className='slide-in-from-right text-center md:text-left'>
                        <Heading level={3} className='slide-in-from-right text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-black'>About <span className='text-primary'> Afrimeets</span></Heading>
                    </div>
                    <p className='slide-in-from-right text-[#20202080] text-center md:text-left'>Welcome to Afrimeets, the leading platform designed to connect African and Black singles worldwide. We are more than just a connection site—we are a community built to celebrate culture, heritage, and the power of meaningful relationships. Afrimeets provides a trusted, inclusive space for individuals seeking friendship, companionship, or meaningful connections that align with their values, traditions, and goals.
                    </p>
                    <p className='slide-in-from-right text-[#20202080] text-center md:text-left'>At Afrimeets, we understand the beauty and diversity of African and Black identities. Whether you’re in Africa, part of the diaspora, or anywhere around the globe, our platform brings you closer to individuals who truly understand your culture and aspirations.</p>
                    <p className='slide-in-from-right text-[#20202080] text-center md:text-left'>We believe relationships begin with authenticity and connection. Our easy-to-use platform, advanced features, and secure environment make it simple to meet like-minded individuals ready to build meaningful bonds.</p>
                </div>
            </div>
