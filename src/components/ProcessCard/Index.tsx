    ...
    return (
        <Container>
            <div className='flex flex-col md:flex-row items-center justify-center w-full mt-10'>
                <div className=' animate-fadeInFromLeft flex justify-center lg:justify-start md:w-1/2'>
                    <BaseImage
                ...
                <div className='flex flex-col items-center md:items-start md:w-1/2 w-3/4 space-y-4'>
                    <div className='text-center md:text-left'>
                        <Heading level={3} className='animate-fadeInFromRight text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-black'>About Afrimeets –</Heading>
                        <Heading level={3} className='animate-fadeInFromRight text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-black'><span className='text-primary'> Connecting</span> Communities</Heading>
                    </div>
                    <p className='animate-fadeInFromRight text-[#20202080] text-center md:text-left'>Afrimeets is a global platform designed to connect African and Black individuals worldwide. We
                    ...
                    <p className='animate-fadeInFromRight text-[#20202080] text-center md:text-left'>At Afrimeets, we honor the diversity of African and Black identities. Whether you're in Africa,
            ...
            <div className='flex flex-col justify-center mb-24'>
                <Heading level={3} className='animate-fadeInFromRight items-center text-center mt-12 mb-8 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-black'>Why <span className='text-primary'>Afrimeets</span> Stands Out</Heading>
                <div className='grid grid-cols-1 lg:grid-cols-4 space-x-6 space-y-10 lg:space-y-0 items-center text-center'>
                    ...
                    <div className='col-span-1 flex flex-col items-center text-center space-y-6 animate-fadeInFromRight'>
                        <BaseImage
